                ...
                <div class="card_body">
                    <div class="row d-flex">
                        <div class="col-sm-4 createSegment">
                            <a class="btn dim_button create_new"> <i class="glyphicon glyphicon-plus"></i> Create
                                New</a>
                        </div>
                    ...
                    <div class="overflow-x">
                        <table id="filtertable" class="table table-bordered cust-datatable dataTable no-footer">
                            <thead>
                                <tr>
                                    <th style="min-width:50px;">ID</th>
                                    <th style="min-width:150px;">Nom</th>
                                    <th style="min-width:150px;">Vile</th>
                                    <th style="min-width:100px;">Telephone</th>
                                    <th style="min-width:100px;">Etat</th>
